...
/**
 * Creates the GUI to display the student matches.
 */
public class DisplayMatchesGUI {
    ...
    /**
     * Creates the main frame of the display matches.
     */
    ...
    /**
     * Creates the display matches fields, buttons, and the action listeners.
     */
    DisplayMatchesGUI() {
        $$$setupUI$$$();
        DefaultListModel listModel = new DefaultListModel<>();

        studQueue = lg.getMatchQueue();
    ...
    private void $$$setupUI$$$() {
        ...
        label1.setFont(new Font(label1.getFont().getName(), label1.getFont().getStyle(), 22));
        ...
        matchesPanel.add(getInfoButton, new com.intellij.uiDesigner.core.GridConstraints(1, 1, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER, com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK | com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        returnButton = new JButton();
        returnButton.setText("Main Menu");
        matchesPanel.add(returnButton, new com.intellij.uiDesigner.core.GridConstraints(2, 1, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER, com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK | com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    }
    ...
    /**
     * Inner class to create the specific student info pop up
     */
    private class StudentMatch {
        ...
        StudentMatch(DisplayMatchesGUI dm) {
            ...
            theChosenOne = DisplayMatchesGUI.this.theChosenOne;
        ...
        /**
         * Creates the main frame of the student matches information GUI
         */
        private void createFrame() {
            JFrame frame = new JFrame();
            frame.setContentPane(new StudentMatch(dm).studentPanel);
    ...
    /**
     * Inner class to create a popup error dialog.
     * The dialog pops up when a user clicks the "Get Information"
     * button without actually selecting a student match.
     */
    private class MustSelect extends JDialog {
        ...
        /**
         * Creates the button and the action listener.
         */
        MustSelect() {
            $$$setupUIMS$$$();
