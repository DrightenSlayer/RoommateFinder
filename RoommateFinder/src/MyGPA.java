...
public class MyGPA {
    ...
    /**
     * Validates the input to make sure a letter is not counted
     * and to make sure there is a number in the credits field
     * @return true if valid
     */
    private boolean validInput() {
        if (class1Credit.getText().length() > 0 &&
                !class1Credit.getText().matches("[0-9]+")
                || class1Credit.getText().isEmpty())
            return false;
        if (class2Credit.getText().length() > 0 &&
                !class2Credit.getText().matches("[0-9]+"))
            return false;
        if (class3Credit.getText().length() > 0 &&
                !class3Credit.getText().matches("[0-9]+"))
            return false;
        if (class4Credit.getText().length() > 0 &&
                !class4Credit.getText().matches("[0-9]+"))
            return false;
        if (class5Credit.getText().length() > 0 &&
                !class5Credit.getText().matches("[0-9]+"))
            return false;
        if (class6Credit.getText().length() > 0 &&
                !class6Credit.getText().matches("[0-9]+"))
            return false;
        if (class7Credit.getText().length() > 0 &&
                !class7Credit.getText().matches("[0-9]+"))
            return false;
        else
            return true;
    }
    ...
    private String calculate() {
        ...
        if (validInput() && class1Grade.getSelectedItem() != "" && !class1Credit.getText().isEmpty()) {
        ...
        if (validInput() && class2Grade.getSelectedItem() != "" && !class2Credit.getText().isEmpty()) {
        ...
        if (validInput() && class3Grade.getSelectedItem() != "" && !class3Credit.getText().isEmpty()) {
        ...
        if (validInput() && class4Grade.getSelectedItem() != "" && !class4Credit.getText().isEmpty()) {
        ...
        if (validInput() && class5Grade.getSelectedItem() != "" && !class5Credit.getText().isEmpty()) {
        ...
        if (validInput() && class6Grade.getSelectedItem() != "" && !class6Credit.getText().isEmpty()) {
        ...
        if (validInput() && class7Grade.getSelectedItem() != "" && !class7Credit.getText().isEmpty()) {
